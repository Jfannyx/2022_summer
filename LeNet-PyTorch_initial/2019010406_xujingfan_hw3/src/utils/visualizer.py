...
def demo_display_specific_digit_combination(images, labels):
    ...
    digit_4 = digit_image_dict[4]
    digit_6 = digit_image_dict[6]
    target_img = torch.cat((digit_2,digit_0,digit_1,digit_9,digit_0,digit_1,digit_0,digit_4,digit_0,digit_6), 2)
